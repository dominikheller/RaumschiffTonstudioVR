...
public class KippschalterAus : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        anim.Play("KippschalterOffZuOn");

        turnLampOn();

        lautsprecherMixer.SetFloat(effectName + "Wet", 1);
        lautsprecherMixer.SetFloat(effectName + "Dry", 0);
